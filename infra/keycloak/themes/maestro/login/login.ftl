...
<div class="login-container">
  <div class="login-card">
    ...
    <#-- Affiché seulement si au moins un IdP est configuré et non caché. -->
    <#if realm.password && social.providers?? && social.providers?has_content>
      <div class="social-divider">
        <span class="social-divider-line"></span>
        <span class="social-divider-text">ou</span>
        <span class="social-divider-line"></span>
      </div>
      ...
      <div class="social-providers">
        <#list social.providers as p>
          <a class="social-btn social-btn--${p.alias}"
            ...
            <#-- Icônes SVG inline selon l'alias. Les autres providers
                 ont juste leur displayName sans icône. -->
            <#if p.alias == "google">
