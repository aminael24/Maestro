...
const LibraryImage = () => (
  <div className="library-image">
    <img src={image1} alt="Archive visualization" className="feature-image-full" />
  </div>
);

const PrinterImage = () => (
  <div className="printer-image">
    <img src={image2} alt="Delivery visualization" className="feature-image-full" />
  </div>
);

const SentinelImage = () => (
  <div className="sentinel-image-wrap">
    <img src={image3} alt="Security visualization" className="sentinel-image-full" />
  </div>
);
